...
public enum SkillEnum {
    ...
    WELLDRILLING_MASTER("Kútfúró mester",1,1,1,0.4),
    WELLDRILLING_MAGE("Kútfúró mágus",1,1,1,0.6),
    HUNTER_PADAVAN("Vadász inas",1,1,1,0.2),
    HUNTER_MASTER("Vadász mester",1,1,1,0.4),
    HUNTER_MAGE("Vadász mágus",1,1,1,0.6),
    ASTRONOMER_PADAVAN("Csillagvizsgáló inas",1,1,2,0.2),
    ASTRONOMER_MASTER("Csillagvizsgáló mester",1,1,2,0.4),
    ASTRONOMER_MAGE("Csillagvizsgáló mágus", 1,1,2,0.6),
    TREASURE_HUNTER_PADAVAN("Kincsvadász inas",1,1,1,0.2),
    TREASURE_HUNTER_MASTER("Kincsvadász mester",1,1,1,0.4),
    TREASURE_HUNTER_MAGE("Kincsvadász mágus",1,1,1,0.6);
